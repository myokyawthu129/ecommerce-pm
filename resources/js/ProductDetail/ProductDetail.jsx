                            ...
                            <div className="comment-inner">
                              <h6 className="commenter">
                                ...
                                <span className="commenter-rating ratiing-four-star">
                                  ...
                                  <a href="#"><i className="fas fa-star" /></a>
                                  <a href="#"><i className="fas fa-star" /></a>
                                  <a href="#"><i className="fas fa-star empty-rating" /></a>
                                </span>
                              </h6>
  ...
  <div className="axil-product-area bg-color-white axil-section-gap pb--50 pb_sm--30">
    <div className="container">
      <div className="section-title-wrapper">
        <span className="title-highlighter highlighter-primary"><i className="far fa-shopping-basket" /> Your Recently</span>
      ...
      <div className="recent-product-activation slick-layout-wrapper--15 axil-slick-arrow arrow-top-slide">
            ...
            <div className="thumbnail">
              ...
              <div className="product-hover-action">
                <ul className="cart-action">
                  ...
                  <li className="select-option"><a href="cart.html">Add to Cart</a></li>
        ...
        <div className="slick-single-layout">
          <div className="axil-product">
            ...
            <div className="product-content">
              <div className="inner">
                <h5 className="title"><a href="single-product.html">Media remote</a></h5>
                <div className="product-price-variant">
        ...
        <div className="slick-single-layout">
          <div className="axil-product">
            ...
            <div className="product-content">
              <div className="inner">
                <h5 className="title"><a href="single-product.html">HD camera</a></h5>
                <div className="product-price-variant">
        ...
        <div className="slick-single-layout">
          <div className="axil-product">
            ...
            <div className="product-content">
              <div className="inner">
                <h5 className="title"><a href="single-product.html">PS Remote Control</a></h5>
                <div className="product-price-variant">
        ...
        <div className="slick-single-layout">
          <div className="axil-product">
            ...
            <div className="product-content">
              <div className="inner">
                <h5 className="title"><a href="single-product.html">PS5 Remote Control</a></h5>
                <div className="product-price-variant">
                  <span className="price old-price">$50</span>
                  <span className="price current-price">$38</span>
                </div>
    ...
    <div className="container">
      <div className="etrade-newsletter-wrapper bg_image bg_image--5">
        <div className="newsletter-content">
          <span className="title-highlighter highlighter-primary2"><i className="fas fa-envelope-open" />Newsletter</span>
