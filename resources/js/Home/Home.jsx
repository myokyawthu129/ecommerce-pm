...
export default function Home() {
  ...
  {/* <div className="axil-main-slider-area main-slider-style-1">
        ...
        <div className="col-lg-5 col-sm-6">
          <div className="main-slider-content">
            <div className="slider-content-activation-one">
              <div className="single-slide slick-slide" data-sal="slide-up" data-sal-delay={400} data-sal-duration={800}>
                ...
                <div className="slide-action">
                  <div className="shop-btn">
                    <a href="shop.html" className="axil-btn btn-bg-white"><i className="fal fa-shopping-cart" />Shop Now</a>
                  </div>
                  <div className="item-rating">
                    <div className="thumb">
                      <ul>
                        <li><img src="" alt="Author" /></li>
                        <li><img src="" alt="Author" /></li>
                        <li><img src="" alt="Author" /></li>
                        <li><img src="" alt="Author" /></li>
                      </ul>
        ...
        <div className="col-lg-7 col-sm-6">
          <div className="main-slider-large-thumb">
            <div className="slider-thumb-activation-one axil-slick-dots">
              <div className="single-slide slick-slide" data-sal="slide-up" data-sal-delay={600} data-sal-duration={1500}>
    ...
    <ul className="shape-group">
      <li className="shape-1"><img src="{{ asset('web-assets/images/others/shape-1.png') }}" alt="Shape" /></li>
      <li className="shape-2"><img src="{{ asset('web-assets/images/others/shape-2.png') }}" alt="Shape" /></li>
    </ul>
  </div> */}
